...
-- Dump completed on 2025-08-10 14:10:04
  `COMP_TYPE` varchar(100) DEFAULT NULL COMMENT '企业类型大类（中文）',
  `REG_STATE` varchar(20) DEFAULT NULL COMMENT '登记状态（中文）',
  `UNI_SOCIAL_CRD_CD` varchar(50) NOT NULL COMMENT '统一社会信用代码',
  `COMP_NM` varchar(200) DEFAULT NULL COMMENT '企业名称（字号名称）',
  `ADDR` varchar(500) DEFAULT NULL COMMENT '住所（登记、个体户经营场所）',
  `LEGAL_REPRE` varchar(50) DEFAULT NULL COMMENT '法定代表人(经营者姓名)',
  `INDV_ID` varchar(20) DEFAULT NULL COMMENT '行业代码（中文）',
  `REG_CAPT` decimal(15,2) DEFAULT NULL COMMENT '注册资本(资金数额)',
  `CAPT_KIND` varchar(20) DEFAULT NULL COMMENT '币种',
  `OPT_SCOP` text COMMENT '经营范围',
  `REG_NO` varchar(50) DEFAULT NULL COMMENT '注册号',
  `APPR_DT` date DEFAULT NULL COMMENT '核准日期（登记、吊销、注销日期）',
  `EST_DT` date DEFAULT NULL COMMENT '成立日期',
  `OPT_FROM` date DEFAULT NULL COMMENT '经营(营业)起始日期',
  `OPT_TO` date DEFAULT NULL COMMENT '经营(营业)截止日期',
  `DOMDI_STRICT` varchar(50) DEFAULT NULL COMMENT '住所所在行政区划',
  `PRO_LOC` varchar(500) DEFAULT NULL COMMENT '生产经营地',
  `OPT_STRICT` varchar(50) DEFAULT NULL COMMENT '生产经营地所在行政区划',
  `POSTAL_CODE` varchar(10) DEFAULT NULL COMMENT '邮政编码',
  `OPT_LOC` varchar(500) DEFAULT NULL COMMENT '经营场所',
  `INDV_NM` varchar(20) DEFAULT NULL COMMENT '行业代码（中文）',

  -- 法定代表人信息 （来自 DW_ZJ_SCJDGL_FDDBRXX 表）
  `PERSONID` varchar(50) DEFAULT NULL COMMENT '人员ID',
  `LEREP_SIGN` tinyint DEFAULT NULL COMMENT '法定代表人标志/首席代表标志/负责人标识 2 董事',
  `NM` varchar(50) DEFAULT NULL COMMENT '姓名',
  `POSITION` varchar(50) DEFAULT NULL COMMENT '职务',
  `CERTYPE` varchar(20) DEFAULT NULL COMMENT '证件类型',
  `COUNTRY` varchar(20) DEFAULT NULL COMMENT '国籍',
  `POSITION_CN` varchar(50) DEFAULT NULL COMMENT '职务（中文名称）',
  `CERTYPE_CN` varchar(50) DEFAULT NULL COMMENT '证件类型（中文）',
  `COUNTRY_CN` varchar(50) DEFAULT NULL COMMENT '国籍（中文）',
  `CER_NO` varchar(20) DEFAULT NULL COMMENT '身份证件号码',
  `TEL_NUM` varchar(20) DEFAULT NULL COMMENT '固定电话',
  `MOBTEL` varchar(20) DEFAULT NULL COMMENT '移动电话',
  `EMAIL` varchar(100) DEFAULT NULL COMMENT '电子邮箱',
  ...
  `INCLU_DT` date DEFAULT NULL COMMENT '列入日期',
  `INCLU_REASON` varchar(200) DEFAULT NULL COMMENT '列入经营异常名录原因',
  `REDECORG_CN` varchar(100) DEFAULT NULL COMMENT '作出决定机关(移出)',
  `REMEXCPRES_CN` varchar(200) DEFAULT NULL COMMENT '移出经营异常名录原因',
  `REMOVE_DT` date DEFAULT NULL COMMENT '移出日期',
  `DECORG_CN` varchar(100) DEFAULT NULL COMMENT '作出决定机关(列入)',

  -- 严重违法失信企业名单信息 （来自 DW_ZJ_SCJDGL_YZWFSX 表）
  `ILL_COMP_ID` varchar(50) DEFAULT NULL COMMENT '严重违法失信企业名单ID',
  `ABN_TM` date DEFAULT NULL COMMENT '列入日期',
  `SERILL_REA` varchar(200) DEFAULT NULL COMMENT '列入严重违法失信企业名单原因',
  `REM_DT` date DEFAULT NULL COMMENT '移出日期',
  `RECORG_OGR` varchar(100) DEFAULT NULL COMMENT '作出决定机关(移出)',
  `REM_EXCPRES_REA` varchar(200) DEFAULT NULL COMMENT '移出严重违法失信企业名单原因',
  `DECORG_ORG` varchar(100) DEFAULT NULL COMMENT '作出决定机关(列入)',

  -- 企业年报网站或网店信息 （来自 DW_NB_SCJDGL_QYNBWZHWDXX 表）
  `WEB_ID` varchar(50) DEFAULT NULL COMMENT '网站标识',
  `ANNUAL_ID` varchar(50) DEFAULT NULL COMMENT '年报ID',
  `WEB_STORE_TYPE` varchar(50) DEFAULT NULL COMMENT '网站网店类型',
  `WEB_STORE_NM` varchar(200) DEFAULT NULL COMMENT '网站（网店）名称',
  `WEB_STORE_URL` varchar(500) DEFAULT NULL COMMENT '网站（网店）网址',
  `WEB_TYPE` varchar(50) DEFAULT NULL COMMENT '网站类型',
  `WEB_PLAT_TYPE` varchar(50) DEFAULT NULL COMMENT '网络交易平台运营类型',
  `WEB_PRODUCT_TYPE` varchar(50) DEFAULT NULL COMMENT '网络交易产品类型',
  `ECOM_TYPE` varchar(50) DEFAULT NULL COMMENT '电商类型',
  `ICP_NO` varchar(50) DEFAULT NULL COMMENT 'ICP证号/备案号',
  `WECHAT_PUBLIC` varchar(100) DEFAULT NULL COMMENT '微信公众服务号',
  `APP_NM` varchar(100) DEFAULT NULL COMMENT 'APP软件名称',
  `PLAT_NM` varchar(100) DEFAULT NULL COMMENT '所属平台名称',
  `DELI_ADDR` varchar(500) DEFAULT NULL COMMENT '发货地址',
  `RETURN_ADDR` varchar(500) DEFAULT NULL COMMENT '退货地址',
  `PRIPID` varchar(50) DEFAULT NULL COMMENT '主体身份代码',
  `ANNUAL_YEAR` int DEFAULT NULL COMMENT '年报年度',

  -- 股权变更信息 （来自 DW_NB_SCJDGL_GQBG 表）
  `INV` varchar(100) DEFAULT NULL COMMENT '股东',
  `ALT_DT` date DEFAULT NULL COMMENT '股权变更日期',
  `PUBLIC_DT` date DEFAULT NULL COMMENT '公示日期',
  `TRANSAMPR_BF` decimal(5,2) DEFAULT NULL COMMENT '变更前股权比例',
  `TRANSAMPR_AF` decimal(5,2) DEFAULT NULL COMMENT '变更后股权比例',
  ...
  `ASSET_ZMT` decimal(15,2) DEFAULT NULL COMMENT '资产总额',
  `DEBT_AMT` decimal(15,2) DEFAULT NULL COMMENT '负债总额',
  `OWNER_EQUITY_TOATAL` decimal(15,2) DEFAULT NULL COMMENT '所有者权益合计',
  `OPT_INCOME_TOTAL` decimal(15,2) DEFAULT NULL COMMENT '营业总收入',
  `PROFIT_TOTAL` decimal(15,2) DEFAULT NULL COMMENT '利润总额',
  `NET_PROFIT` decimal(15,2) DEFAULT NULL COMMENT '净利润',
  `TAX_TOTAL` decimal(15,2) DEFAULT NULL COMMENT '纳税总额',
  ...
  `CREDITOR` varchar(200) DEFAULT NULL COMMENT '债权人',
  `DEBTOR` varchar(200) DEFAULT NULL COMMENT '债务人',
  `MAJOR_CREDIT_TYPE` varchar(50) DEFAULT NULL COMMENT '主债权种类',
  `MAJOR_CREDIT_AMT` decimal(15,2) DEFAULT NULL COMMENT '主债权数额',
  `PERIOD_FROM` date DEFAULT NULL COMMENT '履行债务的期限自',
  `PERIOD_TO` date DEFAULT NULL COMMENT '履行债务的期限至',
  `PROMIS_DUR` varchar(50) DEFAULT NULL COMMENT '保证的期间',
  `IS_PUBLIC` varchar(10) DEFAULT NULL COMMENT '对外担保是否公示',
  `PROMIS_WAY` varchar(50) DEFAULT NULL COMMENT '保证的方式',
  ...
  `EXECUTED_NM` varchar(100) DEFAULT NULL COMMENT '被执行人姓名/名称',
  `IDENTI_ID` varchar(20) DEFAULT NULL COMMENT '身份证号码',
  `LEGAL_REPRE` varchar(50) DEFAULT NULL COMMENT '法定代表人或者负责人姓名',
  `EXECUTED_COURT` varchar(100) DEFAULT NULL COMMENT '执行法院',
  `ENFORCE_BASIS` varchar(100) DEFAULT NULL COMMENT '执行依据文号',
  `FIL_DT` date DEFAULT NULL COMMENT '立案时间',
  `CASE_NO` varchar(50) DEFAULT NULL COMMENT '案号',
  `DECI_EXECUTED_UNIT` varchar(100) DEFAULT NULL COMMENT '做出执行依据单位',
  `EFFECT_DOC_OBLI` text COMMENT '生效法律文书确定的义务',
  `EXECUTED_PERFOR` varchar(200) DEFAULT NULL COMMENT '被执行人的履行情况',
  `PUBLISH_DT` date DEFAULT NULL COMMENT '发布时间',
  `SEARCH_CASE_YEAR` varchar(10) DEFAULT NULL COMMENT '搜案年号',
  `SEARCH_CASE_NO` varchar(50) DEFAULT NULL COMMENT '搜案编号',
  `PERFORMED_PART` decimal(15,2) DEFAULT NULL COMMENT '已履行部分',
  `UN_PERFORMED_PART` decimal(15,2) DEFAULT NULL COMMENT '未履行部分',
  `DISHONEST_ID` varchar(50) DEFAULT NULL COMMENT '失信ID',
  `GEN` varchar(10) DEFAULT NULL COMMENT '性别',
  `EXECUTED_NATURE` varchar(50) DEFAULT NULL COMMENT '被执行人性质',
  `BIRTH_DT` date DEFAULT NULL COMMENT '出生日期',
  `DISHONEST_BEHAV` varchar(200) DEFAULT NULL COMMENT '失信被执行人行为情况',

  -- 纳税信息 （来自 DW_NB_SW_NSXX 表）
  `TAX_AMT` decimal(15,2) DEFAULT NULL COMMENT '纳税总额',
  `SALE_INCO` decimal(15,2) DEFAULT NULL COMMENT '销售收入',
  `COUNT_DT` date DEFAULT NULL COMMENT '统计时间',

  -- 信用评价信息（来自 DW_NB_DSJ_XYPJXX 表）
  `CRED_SCARD` decimal(10,2) DEFAULT NULL COMMENT '信用分',
  `EVAL_DT` date DEFAULT NULL COMMENT '评价时间',

  -- 信用评价信息（A级纳税人） （来自 DW_NB_SW_XYPJXXA 表）
  `CREDI_SCARD` decimal(10,2) DEFAULT NULL COMMENT '信用分',
  `EVAL_ORG` varchar(100) DEFAULT NULL COMMENT '评价机构',
  `TAX_CREDI_LEVEL` varchar(10) DEFAULT NULL COMMENT '纳税信用等级',
  `EVAL_YEAR` int DEFAULT NULL COMMENT '纳税信用等级评定年度',
  `EVAL_DT` date DEFAULT NULL COMMENT '纳税信用等级评定日期',
  `MAJOR_TAX_ORG` varchar(100) DEFAULT NULL COMMENT '主管税务机关',
  ...
  `PENS_PAY_YM` varchar(10) DEFAULT NULL COMMENT '养老保险缴费年月',
  `MEDIC_PAY_YM` varchar(10) DEFAULT NULL COMMENT '医疗保险缴费年月',
  `UNEMPLOY_PAY_YM` varchar(10) DEFAULT NULL COMMENT '失业保险缴费年月',
  `INJURY_PAY_YM` varchar(10) DEFAULT NULL COMMENT '工伤保险缴费年月',
  `MATERNI_PAY_YM` varchar(10) DEFAULT NULL COMMENT '生育保险缴费年月',

  -- 失业保险费核定信息 （来自 DW_NB_RLSB_CBGRYJSYBXFHDXX 表）
  `ISSU_TYPE` varchar(50) DEFAULT NULL COMMENT '险种类型',
  `PAY_MONTHS` int DEFAULT NULL COMMENT '缴费月数',
  `PER_PAY_BASIS` decimal(10,2) DEFAULT NULL COMMENT '个人缴费基数',
  `PAY_AMT` decimal(10,2) DEFAULT NULL COMMENT '缴费总金额',
  `UNIT_PAY_AMT` decimal(10,2) DEFAULT NULL COMMENT '单位应交金额',
  `PER_PAY_AMT` decimal(10,2) DEFAULT NULL COMMENT '个人应缴金额',
  `FEE_PERIOD` varchar(10) DEFAULT NULL COMMENT '费款所属期',

  -- 行政处罚公示信息 （来自 DW_NB_SCJDGL_XZCFGSXX 表）
  `ADMIN_PUNISH_DOC` varchar(100) DEFAULT NULL COMMENT '行政处罚文号',
  `PUNISH_REA` varchar(500) DEFAULT NULL COMMENT '处罚原因',
  `PUNISH_DT` date DEFAULT NULL COMMENT '处罚时间',
  `PUNISH_RESULT` varchar(200) DEFAULT NULL COMMENT '处罚结果',

  PRIMARY KEY (`UNI_SOCIAL_CRD_CD`),
  KEY `idx_industry_code` (`INDV_NM`),
  KEY `idx_area` (`DOMDI_STRICT`),
  KEY `idx_company_type` (`COMP_TYPE`)

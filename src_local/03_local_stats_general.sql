...
SELECT
    ...
    COUNT(*) AS total_company, -- 企业总数
    COUNT(CASE WHEN PENS_NUM IS NOT NULL THEN 1 END) AS company_with_social_insurance, -- 参与社保企业数
    COUNT(CASE WHEN PENS_NUM IS NULL THEN 1 END) AS company_without_social_insurance, -- 未参与社保企业数
